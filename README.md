...
| [GitHub CLI](https://cli.github.com) | GitHub 배포 (인증용) | `brew install gh` → `gh auth login` | [다운로드](https://cli.github.com) → `gh auth login` |

> **GitHub Pages 배포**는 `gh auth login`을 한 번 실행한 뒤 Step 5에서 바로 사용할 수 있습니다. 자세한 방법은 [INSTALL.md의 GitHub Pages 배포](INSTALL.md#github-pages로-배포하기-로컬) 참고.
